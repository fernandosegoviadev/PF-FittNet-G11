...
export function Create () {
    ...
    function onSubmit(e) {
        ...
        if (name && email && password && type) {
            ...
            axios.post('http://localhost:3001/api/register', userCreate)
            .then((res)=>{  
    ...
    return (        
        ...
        <div>
            ...
            <div>
                ...
                <select name="select" 
                onChange = {(e)=> e.target.value === "Tipo de cliente" ? null : setType(e.target.value)} >
                ...
                <form >
                  ...
                  <input type='submit' value='Registrarse' onClick={(e)=>onSubmit(e)} />
                </form>
